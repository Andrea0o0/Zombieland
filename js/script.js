...
background1.onclick = function(){
    ...
    console.log(world)
    // worldsize.push(background1_Image.naturalWidth)
    // worldsize.push(background1_Image.naturalHeight)
}
...
background2.onclick = function(){
    ...
    world = {
        width:background2_Image.naturalWidth
    }
    // worldsize.push(background2_Image.naturalWidth)
    // worldsize.push(background2_Image.naturalHeight)
}
...
background3.onclick = function(){
    ...
    world = {
        width:background3_Image.naturalWidth
    }
    // worldsize.push(background3_Image.naturalWidth)
    // worldsize.push(background3_Image.naturalHeight)
}
...
background4.onclick = function(){
    ...
    world = {
        width:background4_Image.naturalWidth
    }
    // worldsize.push(background4_Image.naturalWidth)
    // worldsize.push(background4_Image.naturalHeight)
}
...
background5.onclick = function(){
    ...
    world = {
        width:background5_Image.naturalWidth
    }
    // worldsize.push(background5_Image.naturalWidth)
    // worldsize.push(background5_Image.naturalHeight)
}
...
background6.onclick = function(){
    ...
    world = {
        width:background6_Image.naturalWidth
    }
    // worldsize.push(background6_Image.naturalWidth)
    // worldsize.push(background6_Image.naturalHeight)
}
